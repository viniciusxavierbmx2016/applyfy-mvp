...
// FASE 6.0 Fatia 3 — CRUD do secret do webhook Hubla (WorkspaceGatewaySecret,
// gateway="hubla"). Molde do applyfy-tokens, MAS o value é CIFRADO via encrypt()
// na escrita e mascarado (decrypt+mask) na leitura — nunca devolve o valor cru.
...
function handleError(error: unknown) {
  ...
  console.error("/api/producer/integrations/hubla-secrets error:", error);
