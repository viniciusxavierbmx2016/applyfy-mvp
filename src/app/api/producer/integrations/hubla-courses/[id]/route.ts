...
// FASE 6.0 Fatia 3 — mapeamento produto→curso do gateway HUBLA. Molde do
// integrations/courses/[id] PATCH, MAS: (1) escreve gateway="hubla" no createMany,
// (2) o replace-set + o conflito são escopados a gateway="hubla", (3) NÃO sincroniza
// Course.externalProductId (o campo legado é do Applyfy — intocado).
...
export async function PATCH(
  ...
  try {
    ...
    // Unicidade por (workspace, gateway="hubla"): rejeita id já usado por OUTRO curso
    ...
    // Replace-set escopado a gateway="hubla" (deixa os mapeamentos de outros gateways
    ...
    console.error("PATCH /api/producer/integrations/hubla-courses/[id] error:", error);
