...
// FASE 6.1d Perfect Pay — mapeamento produto→curso do gateway PERFECT PAY. Clone do kiwify-courses/[id]:
// escreve gateway="perfectpay" no createMany, replace-set + conflito escopados a gateway="perfectpay",
...
export async function PATCH(
  ...
  try {
    ...
    // Unicidade por (workspace, gateway="perfectpay"): rejeita id já usado por OUTRO curso
    ...
    // Replace-set escopado a gateway="perfectpay" (deixa os mapeamentos de outros gateways
    ...
    console.error("PATCH /api/producer/integrations/perfectpay-courses/[id] error:", error);
