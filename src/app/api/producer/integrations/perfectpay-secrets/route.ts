...
// FASE 6.1d Perfect Pay — CRUD do secret do webhook Perfect Pay (WorkspaceGatewaySecret, gateway="perfectpay").
// Clone do kiwify-secrets: o value é CIFRADO via encrypt() na escrita e mascarado
// (decrypt+mask) na leitura — nunca devolve o valor cru. O token é o que a Perfect Pay envia no CORPO de cada webhook.
...
function handleError(error: unknown) {
  ...
  console.error("/api/producer/integrations/perfectpay-secrets error:", error);
