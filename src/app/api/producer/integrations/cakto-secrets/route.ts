...
// FASE 6.1c Cakto — CRUD do secret do webhook Cakto (WorkspaceGatewaySecret, gateway="cakto").
// Clone do kiwify-secrets: o value é CIFRADO via encrypt() na escrita e mascarado
// (decrypt+mask) na leitura — nunca devolve o valor cru. O secret é o que a Cakto envia no CORPO de cada webhook.
...
function handleError(error: unknown) {
  ...
  console.error("/api/producer/integrations/cakto-secrets error:", error);
