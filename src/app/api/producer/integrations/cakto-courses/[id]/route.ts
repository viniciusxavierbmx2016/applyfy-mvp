...
// FASE 6.1c Cakto — mapeamento produto→curso do gateway CAKTO. Clone do kiwify-courses/[id]:
// escreve gateway="cakto" no createMany, replace-set + conflito escopados a gateway="cakto",
...
export async function PATCH(
  ...
  try {
    ...
    // Unicidade por (workspace, gateway="cakto"): rejeita id já usado por OUTRO curso
    ...
    // Replace-set escopado a gateway="cakto" (deixa os mapeamentos de outros gateways
    ...
    console.error("PATCH /api/producer/integrations/cakto-courses/[id] error:", error);
