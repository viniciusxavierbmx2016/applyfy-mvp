    ...
    return NextResponse.json(
      {
        ...
        workspace: {
          ...
          memberBgColor: workspace.memberBgColor,
          memberSidebarColor: workspace.memberSidebarColor,
          memberHeaderColor: workspace.memberHeaderColor,
          memberCardColor: workspace.memberCardColor,
          memberPrimaryColor: workspace.memberPrimaryColor,
          memberTextColor: workspace.memberTextColor,
          memberAccentColor: workspace.memberAccentColor,
          memberBannerUrl: workspace.memberBannerUrl,
          memberWelcomeText: workspace.memberWelcomeText,
          memberLayoutStyle: workspace.memberLayoutStyle,
        },
