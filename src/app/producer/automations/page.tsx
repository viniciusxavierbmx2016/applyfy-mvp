...
function SidePanel({
  ...
  return (
    <div className="absolute top-0 right-0 h-full w-[400px] bg-white dark:bg-gray-950 border-l border-gray-200 dark:border-white/10 shadow-2xl flex flex-col z-10 animate-slideIn">
                    ...
                    {actionType === "SEND_PUSH" && (
                      <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5 rounded-xl p-3">
                          ...
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3 space-y-0.5 border border-gray-100 dark:border-white/5">
