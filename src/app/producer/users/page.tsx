                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {u.phone && (
                          <a
                            ...
                            className="inline-flex items-center gap-1 text-xs text-emerald-500 hover:text-emerald-400 transition-colors flex-shrink-0"
                            title={`Chamar ${u.name} no WhatsApp`}
