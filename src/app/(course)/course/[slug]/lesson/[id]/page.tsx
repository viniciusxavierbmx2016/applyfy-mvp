...
export default function LessonPage(
  ...
  if (loading) {
    return (
      <div className="flex flex-col h-full bg-white dark:bg-gray-950">
        <div className="h-[52px] shrink-0 border-b border-gray-200 dark:border-white/5 bg-gray-50 dark:bg-gray-900" style={{ backgroundColor: 'var(--member-header)' }} />
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-950">
      {/* Topbar */}
      <div className="h-[52px] shrink-0 border-b border-gray-200 dark:border-white/5 bg-gray-50 dark:bg-gray-900 flex items-center justify-between px-4 z-10" style={{ backgroundColor: 'var(--member-header)' }}>
