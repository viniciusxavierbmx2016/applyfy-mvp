        ...
        <div className="grid gap-4">
          {sorted.map((live) => (
            <Link
              ...
              className="block bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-xl overflow-hidden isolate will-change-transform p-4 hover:bg-gray-50 dark:hover:bg-white/[0.05] transition-[transform,box-shadow,border-color,background-color] duration-300 lg:hover:scale-[1.02] lg:hover:shadow-xl lg:hover:shadow-black/20 lg:hover:border-gray-300 dark:lg:hover:border-white/20"
            >
