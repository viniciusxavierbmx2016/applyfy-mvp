        ...
        <div className="w-full max-w-xl">
          {valid && cert ? (
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 sm:p-10 text-center">
              ...
              <p className="text-sm text-gray-400">
                O código{" "}
                <span className="font-mono text-gray-300">{code}</span> não
...
function Row({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 border-b border-gray-800 pb-3 last:border-0 last:pb-0">
