...
interface WorkspaceResetFormProps {
  workspace: WorkspaceAuthInfo;
  slug: string;
}

function ResetFormInner({ workspace, slug }: WorkspaceResetFormProps) {
    ...
    <WorkspaceAuthShell
      ...
      title={
        workspace.loginTitle
          ? `${workspace.loginTitle} · Nova senha`
          : "Definir nova senha"
      }
...
export function WorkspaceResetForm(props: WorkspaceResetFormProps) {
  return (
