...
/* ─────────────────────────────────────────────────────────────
   ...
   dashboard (bg-white dark:bg-white/5 etc.). Icons are passed
...
export function Section({
  ...
  return (
    <section className="rounded-xl border bg-white dark:bg-white/5 border-gray-200 dark:border-white/5 p-6 sm:p-7">
...
export function KpiCard({
  ...
  return (
    <div className="rounded-xl border bg-white dark:bg-white/5 border-gray-200 dark:border-white/5 p-5">
