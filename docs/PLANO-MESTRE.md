...
- [ ] **9.36 — Home e aula sem folga para o home indicator** 🟡 — ambas usam `p-4 lg:p-8` (16px no mobile) contra os ~34px do indicador. Nenhuma tela do aluno reservava espaço; a comunidade passou a ser a única com folga depois do `9.35a`. Corrigir junto com o 9.35b ou antes dele, com o mesmo `pb` sem `env()`.
