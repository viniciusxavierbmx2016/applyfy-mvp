...
- FASE 2: 2.1 HSTS `de00875` · 2.2 npm audit `7eaaf66` · 2.3 XSS `3d40bc3` · 2.6/2.6b email sanitize `aa0e1a2`/`98b1381` · 2.7 + Candidato-2 (não-itens) · **2.4 Peça A shared-store Upstash `75c07be`**. Abertos: **2.4** Peça B (origin lockdown) + constant-time · **2.5** CSP.
